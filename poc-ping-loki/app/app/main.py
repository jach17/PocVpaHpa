...
from fastapi import FastAPI, Request, Response, status # Import status for error logging
import httpx
...
OTLP_GRPC_ENDPOINT = os.environ.get("OTLP_GRPC_ENDPOINT", "http://grafana-alloy:4317")
